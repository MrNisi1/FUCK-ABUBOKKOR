...
\033[1;90m══════════════════════════════════════════════════
    """)
		...
		print("")
		print("%s [%s1%s]%s CRACK RANDOM FB ID 2012-15 %s(PRO) [Slow]"%(R,G,R,Y,G))
		print("%s [%s2%s]%s CRACK RANDOM FB ID 2011-13 %s(PRO) [Slow]"%(R,G,R,Y,G))
		print("%s [%s3%s]%s CRACK RANDOM FB ID 2008-11 %s(PRO) [Slow]"%(R,G,R,Y,G))
